    ...
    if (contactForm) {
        ...
        function validateForm() {
            ...
            fields.forEach(function(field) {
                if (field.hasAttribute('data-validate') || field.required || field.type === 'email') {
            ...
            if (isValid) {
                ...
                .then(function(response) {
                    if (response.ok) {
                        ...
                        if (!successMessage) {
                            ...
                            message.textContent = contactForm.getAttribute('data-success-message') || 'Form submitted successfully!';
                            contactForm.appendChild(message);
                        }
                        
                        const fields = contactForm.querySelectorAll('.success');
                        fields.forEach(function(field) {
                            field.classList.remove('success');
                        });
                    } else {
                ...
                .catch(function(error) {
                    ...
                    if (!errorMessage) {
                        ...
                        message.textContent = contactForm.getAttribute('data-error-message') || 'An error occurred. Please try again.';
                        contactForm.appendChild(message);
                    }
                });
            }
        ...
        function handleScrollAnimations() {
            animatedElements.forEach(function(element) {
                if (!element.classList.contains('animated')) {
                    const offset = parseInt(element.getAttribute('data-animate-offset'), 10) || 100;
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'e0043265-3519-429f-b167-308467a5c1d1',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'e0043265-3519-429f-b167-308467a5c1d1';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'e0043265-3519-429f-b167-308467a5c1d1';
